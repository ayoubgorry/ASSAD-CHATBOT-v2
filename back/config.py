...
URL_WIKIPEDIA = "https://fr.wikipedia.org/wiki/Coupe_d%27Afrique_des_nations_de_football_2025"
USER_AGENT = "AyoubGorryBot/1.0"

BASE_DATA_DIR = "data"
MATCHS_DIR = os.path.join(BASE_DATA_DIR, "matches")
METADATA_DIR = os.path.join(BASE_DATA_DIR, "metadata")

VERSION_FILE = os.path.join(METADATA_DIR, "versions.json")
